        ...
        for (int i = 0; i < profiles.Count; i++)
        {
            ...
            else
            {
                ...
                foreach (string flag in splitFlags)
                {
                    ...
                    if (Enum.TryParse(workingFlag, out TerritorySystem_DataTypes.AdditionalTerritoryFlags testAdditionalFlag) &&
                        Enum.IsDefined(typeof(TerritorySystem_DataTypes.AdditionalTerritoryFlags), testAdditionalFlag))
                    {
                    ...
                    switch (testFlag)
                    {
                        ...
                        case TerritorySystem_DataTypes.TerritoryFlags.MoveSpeedMultiplier:
                            ...
                            break;
                        case TerritorySystem_DataTypes.TerritoryFlags.ForceGroundHeight or TerritorySystem_DataTypes.TerritoryFlags.AddGroundHeight
                        ...
                        case TerritorySystem_DataTypes.TerritoryFlags.CustomPaint:
                            _paintGround = (TerritorySystem_DataTypes.PaintType)Convert.ToInt32(customData, new CultureInfo("en-US"));
                            break;
                    }
                }
