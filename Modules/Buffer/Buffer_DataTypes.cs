...
public static class Buffer_DataTypes
{
    ...
    public class BufferBuffData : ISerializableParameter
    {
        ...
        public bool Init()
        {
            ...
            if (obj)
            {
                if (obj.GetComponent<Character>())
                {
                    ...
                    Icon =  PhotoManager.__instance.GetSprite(obj.name, AssetStorage.AssetStorage.PlaceholderMonsterIcon, 1);
                }
        ...
        public bool CanTake()
        {
            return Player.m_localPlayer && !string.IsNullOrEmpty(BuffGroup) && !Player.m_localPlayer.GetSEMan().m_statusEffects
